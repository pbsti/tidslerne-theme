    ...
    <div class="flex max-w-md space-x-6 mt-6">
      <div class="newsletter">
        <div class="tnp tnp-subscription ">
          ...
          <div class="tnp-field tnp-field-button bg-[#2B682C] text-[#ededed] px-4 py-2 rounded-md cursor-pointer"><input class="tnp-submit" type="submit" value="Subscribe" style="">
          </div>
          </form>
        </div>
      </div>
